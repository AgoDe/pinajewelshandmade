                ...
                <div class="row g-0 align-items-center w-100">
                    ...
                    <div class="col-4 col-sm-4 col-md-4 col-lg-5 d-none d-lg-block">
                        <ul class="social-icons list-inline">
                            ...
                            <li class="list-inline-item"><a href="//www.instagram.com/pina_jewelshandmade/" target="_blank"><i class="an an-instagram" aria-hidden="true" ></i><span class="tooltip-label">Instagram</span></a></li>
